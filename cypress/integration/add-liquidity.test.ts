describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-token .token-symbol-container').should('contain.text', 'CAKE')
  ...
  it('token not in storage is loaded', () => {
    ...
    cy.get('#add-liquidity-input-token .token-symbol-container').should('contain.text', 'BUSD')
  ...
  it('single token can be selected', () => {
    ...
    cy.get('#add-liquidity-input-token .token-symbol-container').should('contain.text', 'DOT')
